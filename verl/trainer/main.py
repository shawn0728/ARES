...
from .data_loader import create_dataloader, create_bootstrap_dataloader
...
class Runner:
    ...
    def run(self, config: PPOConfig):
        ...
        train_dataloader, val_dataloader, train_dataset = create_dataloader(config.data, tokenizer, processor)
        if config.data.bootstrap:
            bootstrap_train_dataloder, bootstrap_val_dataloader = create_bootstrap_dataloader(config.data, tokenizer, processor)
            trainer = RayPPOTrainer(
                ...
                bootstrap_train_dataloder=bootstrap_train_dataloder,
