...
RUN_ID=adaptive_cs_v2_VIRL39k_grpo_crucial_tk_entropy_dynamic_sampling_multinode_bsz_1024

export PYTHONUNBUFFERED=1

EXPERIMENT_NAME=adaptive_cs_v2_VIRL39k_grpo_crucial_tk_entropy_dynamic_sampling_multinode_bsz_1024
