...
RUN_ID=adaptive_cs_v2_VIRL39k_grpo_crucial_tk_entropy_dynamic_sampling_multinode_bsz_2048

export PYTHONUNBUFFERED=1

EXPERIMENT_NAME=adaptive_cs_v2_VIRL39k_grpo_crucial_tk_entropy_dynamic_sampling_multinode_bsz_2048
...
python3 -m verl.trainer.main \
    ...
    trainer.load_checkpoint_path=/cpfs/user/yym/projects/Adaptive-VL-worktrees/exp_crucial_token_entropy/checkpoints/Adaptive_thinking/adaptive_cs_v2_VIRL39k_grpo_crucial_tk_entropy_dynamic_sampling_multinode \
