...
RUN_ID=exp_crucial_token_adaptive_v2_multinode_wo_dynamic_sampling_0724

export PYTHONUNBUFFERED=1

EXPERIMENT_NAME=adaptive_cs_v2_geo3k_grpo_crucial_tk_entropy_wo_dynamic_sampling_multinode
