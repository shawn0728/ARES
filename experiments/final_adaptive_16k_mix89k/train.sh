...
PROJECT_NAME=AdaEntropy
RUN_ID=final_adaptive_16k_mix89k

export PYTHONUNBUFFERED=1

EXPERIMENT_NAME=final_adaptive_16k_mix89k
MODEL_PATH=/cpfs/user/yym/models/adaptive-mm-v02  # replace it with your local file path
#MODEL_PATH=/cpfs/data/chenshuang/models/Qwen2.5-VL-7B-Instruct # replace it with your local file path
...
python3 -m verl.trainer.main \
    ...
    data.train_files=/cpfs/user/yym/hugging_face/datasets/mix_geo3k_like/mix_geo3k_like_w_global_id.parquet \
    data.val_files=/cpfs/user/yym/hugging_face/datasets/mathvista_in_geo3k_format/mathvista_in_geo3k_format_w_global_id.parquet \
