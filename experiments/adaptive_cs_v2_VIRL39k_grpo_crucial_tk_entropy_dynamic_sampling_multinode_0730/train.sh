...
RUN_ID=adaptive_cs_v2_VIRL39k_grpo_crucial_tk_entropy_dynamic_sampling_multinode_0730

export PYTHONUNBUFFERED=1

EXPERIMENT_NAME=adaptive_cs_v2_VIRL39k_grpo_crucial_tk_entropy_dynamic_sampling_multinode_0730
