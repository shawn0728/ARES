...
RUN_ID=adaptive_cs_v2_geo3k_grpo_crucial_tk_entropy_wo_dynamic_sampling_multinode_0729

export PYTHONUNBUFFERED=1

EXPERIMENT_NAME=adaptive_cs_v2_geo3k_grpo_crucial_tk_entropy_wo_dynamic_sampling_multinode_0729
