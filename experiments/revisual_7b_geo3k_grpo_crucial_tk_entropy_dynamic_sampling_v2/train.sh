...
RUN_ID=exp_crucial_token_trial_one

export PYTHONUNBUFFERED=1

EXPERIMENT_NAME=revisual_7b_geo3k_grpo_crucial_tk_entropy_dynamic_sampling
...
python3 -m verl.trainer.main \
    ...
    trainer.load_checkpoint_path=/cpfs/user/yym/projects/Adaptive-VL-worktrees/exp_crucial_token_entropy/checkpoints/Adaptive_thinking/${EXPERIMENT_NAME} \
