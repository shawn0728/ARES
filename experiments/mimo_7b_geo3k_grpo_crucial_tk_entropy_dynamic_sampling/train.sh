...
RUN_ID=exp_crucial_token_mimo

export PYTHONUNBUFFERED=1

EXPERIMENT_NAME=mimo_7b_geo3k_grpo_crucial_tk_entropy_dynamic_sampling
MODEL_PATH=/cpfs/user/yym/models/mimo-7b-sft-vl  # replace it with your local file path
