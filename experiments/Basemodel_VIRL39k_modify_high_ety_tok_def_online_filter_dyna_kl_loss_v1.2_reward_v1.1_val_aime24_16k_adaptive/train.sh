...
RUN_ID=Basemodel_VIRL39k_modify_high_ety_tok_def_online_filter_dyna_kl_loss_v1.2_reward_v1.1_val_aime24_16k_adaptive

export PYTHONUNBUFFERED=1

EXPERIMENT_NAME=Basemodel_VIRL39k_modify_high_ety_tok_def_online_filter_dyna_kl_loss_v1.2_reward_v1.1_val_aime24_16k_adaptive
...
python3 -m verl.trainer.main \
    ...
    data.val_files=/cpfs/user/yym/hugging_face/datasets/aime24_with_id.jsonl \
