...
RUN_ID=adaptive_cs_v2_geo3k_grpo_crucial_tk_entropy_wo_dynamic_sampling_0729

export PYTHONUNBUFFERED=1

EXPERIMENT_NAME=adaptive_cs_v2_geo3k_grpo_crucial_tk_entropy_wo_dynamic_sampling_0729
MODEL_PATH=/cpfs/user/yym/models/adaptive-mm-v02  # replace it with your local file path

echo "当前使用的 Python 路径是: $(which python)"

/cpfs/data/chenshuang/tool/envs/csgo/bin/python -m verl.trainer.main \
