...
bash /cpfs/user/yym/projects/Adaptive-VL-worktrees/exp_crucial_token_entropy/experiments/Basemodel_VIRL39k_4k_entropy_test_reward_v1.4_dyna_kl_loss_mmv02_0824_alpha_025/train.sh