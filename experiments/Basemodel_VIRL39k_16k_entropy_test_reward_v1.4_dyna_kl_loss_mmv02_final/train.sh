...
RUN_ID=Basemodel_VIRL39k_16k_entropy_test_reward_v1.4_dyna_kl_loss_mmv02_final

export PYTHONUNBUFFERED=1

EXPERIMENT_NAME=Basemodel_VIRL39k_16k_entropy_test_reward_v1.4_dyna_kl_loss_mmv02_final   
